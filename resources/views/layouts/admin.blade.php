        ...
        <div style="background-color: #2c3e50;" style="width: 100%;">
            <div class="container-fluid">
                <nav style="background-color: #2c3e50 !important; max-width: 100%;" class="navbar navbar-expand-md navbar-light bg-light">
                    ...
                    <div class="navbar collapse navbar-collapse nav-contnr" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto flex-fill nav-flow">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="z-index: 9999; left: inherit; right: 0; position: absolute;">
