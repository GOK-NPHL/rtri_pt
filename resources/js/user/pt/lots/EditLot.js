...
import { UpdateLot, FetchReadiness, FetchuserId, FetchLot } from '../../../components/utils/Helpers';
                                            ...
                                            <div className="row">
                                                ...
                                                <div className='col-md-12'>
                                                    <div className="form-group">
                                                        <div style={{ width: '100%', display: 'flex', flexDirection: 'row', marginBottom: '6px', gap: '5px' }}>
                                                            ...
                                                            {this.state.payload && this.state.payload.ending_ids && this.state.payload.ending_ids.length > 4
                                                ...
                                                <div className='col-md-12 mt-3'>
                                                    <input type="submit" disabled={
                                                        !this.state.payload?.name || !this.state.payload?.readiness_id || !this.state.payload?.ending_ids || (this.state.payload?.ending_ids.length < 2 || this.state.payload?.ending_ids.length > 4)
